...
/*void LoadUpdateBase() {
    ...
    size_t sizeWords = 100;
    size_t countWords = 15000;
    int count = 0;
...
void TestDuration() {
    ...
    SearchServer src;
    ifstream inFileBase("base.txt");
    {
        LOG_DURATION("UpdateBase");
        src.UpdateDocumentBase(inFileBase);
    }
    ifstream inFileRequest("request.txt");
    ofstream outFileSearchResult("result.txt");
    {
        LOG_DURATION("Request");
        src.AddQueriesStream(inFileRequest, outFileSearchResult);
    }
